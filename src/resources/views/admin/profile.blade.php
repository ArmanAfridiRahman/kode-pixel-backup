...
@push("styles")
 <style>
	 ...
	 .profile-details-top{
		background-image: url({{imageUrl(config("settings")['file_path']['profile']['admin']['path']."/".@$user->file->name ,@$user->file->disk )}}) ;
	 }
	...
	<div class="mb-20">
		<div class="profile-details-top">
			<div class="profile-info">
				<div class="image">
					<img src="{{imageUrl(config("settings")['file_path']['profile']['admin']['path']."/".@$user->file->name ,@$user->file->disk ) }}" alt="{{@$user->file->name}}" />
				</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-inner">
									<label for="Name">{{translate("User Name")}}  <small class="text-danger">* ({{translate('Must Be Unique')}})</small>  </label> 
							...
							<div class="col-lg-6">
								<div class="form-inner">
									<label for="email">
									{{translate('Email')}} 
									<small class="text-danger">* ({{translate('Must Be Unique')}})</small>
									</label>
							...
							<div class="col-lg-6">
								<div class="form-inner">
									<label for="phone">
									{{translate("Phone")}}  <small class="text-danger">({{translate('Must Be Unique')}})   </small>
									</label>
