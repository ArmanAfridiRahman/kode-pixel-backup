    ...
    <div class="col-lg-5">
        <div class="form-wrapper">
            ...
            <form action="{{route('admin.password.verify.code')}}" class="login-right-form" method="post">
                @csrf
                <input hidden type="text" name="email" value="{{session()->get("admin_reset_password_email")}}" id="">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-inner">
                            ...
                            <input   type="text" id="code" name="code" placeholder="{{ translate('Enter Verify Code')}}">
                        </div>
                    </div>
