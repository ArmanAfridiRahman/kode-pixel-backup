...
*/
    ...
    Route::middleware(["visitor",'sanitizer','user.verified',"throttle:$hitLimit,1",'last.login'])->group(function (){
        ...
        Route::controller(FrontendController::class)->group(function (){
            ...
            /** base url  */
            $pageBaseUrl = seo_data('pages');

            Route::get("/",'frontend')->name('home');
            Route::any("/rss",'rss')->name('rss');
